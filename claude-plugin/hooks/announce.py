#!/usr/bin/env python3
"""Agent PTT announcer hook for Claude Code.
...
Design rule: this hook must NEVER interfere with coding. Every failure
path (server down, bad response, anything) exits 0 silently with short
timeouts. Stdlib only — no dependencies.
"""
